...
def analyze_code_with_ai(code: str) -> list:
    ...
    # Define a prompt that instructs the model to analyze the code and return structured feedback
    prompt = f"""
    ...
    # Return structured issues if parsed successfully
    structured_issues = [
        {
...
def analyze_pr_task(self, pr_details):
    ...
    # Analyze each file's content and structure results
